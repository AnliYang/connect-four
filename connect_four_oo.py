class Game(object):
    ...
    def evaluate_board(self, x, y):
        """Evaluates the current board to see if a win or draw has occurred.

        Evaluation of wins is limited to searching around the latest move,
        provided as x, y arguments to the method."""
